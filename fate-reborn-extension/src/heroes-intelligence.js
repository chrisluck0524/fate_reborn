...
export const INTELLIGENCE_HERO_TRANSLATIONS = Object.fromEntries(Object.entries({
  ...
  fate_jakiro_ice: ["冰封", "出牌阶段限一次：弃1张牌，抽取其他角色2张手牌暗置于桌面；你的回合结束时，该角色收回这些牌。"], fate_ice_prison_target: ["冰封", "本回合结束时收回被冰封的手牌。"], fate_jakiro_liquid_fire: ["液态火", "将2张红色手牌当火焰攻击使用；伤害+1。"],
