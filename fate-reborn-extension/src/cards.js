...
export const CARD_TRANSLATIONS = {
  ...
  // Internal effect cards still appear in the action log and playfield.
  // Give them the same user-facing names as the skill that created them.
  fate_medusa_snake_effect: "秘术异蛇",
  fate_razor_field_effect: "等离子场",
  fate_troll_focus_effect_card: "战斗专注",
  fate_nyx_burn_effect: "法力燃烧",
  fate_bloodseeker_rupture_card: "血之狂暴",
  fate_jakiro_ice_effect: "冰封",
  fate_lich_feast_effect: "邪恶祭祀",
  fate_shadow_wave_effect: "暗影波",
  fate_keeper_wave_effect: "冲击波",
  fate_heartstopper_effect_card: "竭心光环",
  fate_crystal_frost_effect_card: "冰霜禁制",
  fate_shallow_grave_effect_card: "薄葬",
